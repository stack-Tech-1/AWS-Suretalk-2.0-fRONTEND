...
import { 
  ...
  Shield, AlertCircle, Filter,
  Search, UserCheck, UserX, Mail,
  Phone, Calendar, Eye, Download,
...
export default function AdminRequests() {
  ...
  const fetchRequestStats = async () => {
    try {
      const response = await api.getAdminRequestStats();
      if (response.success) {
        setStats({
          ...
          avgResponseTime: response.data.avgResponseHours || 0,
          ...
          try {
            ...
            if (statsResponse.success) {
              setStats({
                ...
                total: statsResponse.data.totalRequests || 0,
                avgResponseTime: statsResponse.data.avgResponseHours || 0,
  ...
  return (    
    <div>
      ...
      >
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <button 
                ...
                disabled={stats.pending === 0 || processingBulkAction}
                className={`w-full flex items-center justify-between p-3 rounded-xl border 
                          ${stats.pending === 0 || processingBulkAction 
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Download complete requests report
                    </p>
                  </div>
                </div>
        ...
        {/* Security Metrics - UPDATED WITH REAL DATA */}
        <div className="glass rounded-2xl p-6">
