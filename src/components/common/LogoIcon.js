...
export default function LogoIcon({ size = 36, className = "" }) {
  return (
    ...
    >
      <rect
        x="46" y="46" width="420" height="420" rx="84"
        fill="#FFFFFF" className="fill-white dark:fill-gray-800"
      />
      <g transform="translate(256 262) scale(0.72) translate(-256 -256)">
        ...
        <path
          ...
          fill="#FF5758"
        />
        <rect x="221" y="184" width="70" height="68" rx="17" fill="#FFFFFF" className="fill-white dark:fill-gray-800"/>
        <circle cx="256" cy="274" r="74" fill="#FFFFFF" className="fill-white dark:fill-gray-700"/>
